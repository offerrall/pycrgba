...
ffibuilder.cdef("""
    ...
    void blend(uint8_t* background, uint8_t* overlay, uint32_t bg_width, uint32_t bg_height, uint32_t ov_width, uint32_t ov_height, uint32_t start_x, uint32_t start_y);
    ...
    void blit(uint8_t* dest_image, uint32_t dest_width, uint32_t dest_height, uint8_t* src_image, uint32_t src_width, uint32_t src_height, uint32_t start_x, uint32_t start_y);
    void blit_avx2(uint8_t* dest_image, uint32_t dest_width, uint32_t dest_height, uint8_t* src_image, uint32_t src_width, uint32_t src_height, uint32_t start_x, uint32_t start_y);
